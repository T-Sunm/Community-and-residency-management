...
public class QLNKcontroller implements ActionListener {
	public viewMain v;
	public QLNKcontroller(viewMain v) {
		this.v = v;
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		}else if(src.equals("Sắp xếp theo Số hộ khẩu")) {
			this.v.thuchienSapxeptheoSohokhau();
		}else if(src.equals("Thống kê")) {
			this.v.thuchienchuyenhuongThongke();
		}else if(src.equals("Quay lại")) {
			this.v.thuchienchuyenhuongquaylai();
		}
	}
