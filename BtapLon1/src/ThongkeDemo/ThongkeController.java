...
public class ThongkeController extends JFrame {
	...
	public void setDatetoChart1(JPanel jpnItem) {
		List<NamsinhBean> listIten = thongkeNamsinh.getListByNamSinh();
		if (listIten != null) {
			DefaultCategoryDataset dataset = new DefaultCategoryDataset();
			for (NamsinhBean nhankhauBean : listIten) {
	...
	public void setDatetoChart2(JPanel jpnItem) {
		List<GioiTinhBean> listIten = thongkeGioitinh.getListByGioiTinh();
		if (listIten != null) {
			DefaultCategoryDataset dataset = new DefaultCategoryDataset();
			for (GioiTinhBean gioiTinhBean : listIten) {
